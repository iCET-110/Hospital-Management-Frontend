...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, UpdateComponent, AppointmentHandlingComponent, MedicalRecordsHandlingComponent, PatientManagementComponent, PrescriptionManagementComponent],
